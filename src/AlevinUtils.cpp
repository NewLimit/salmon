...
std::unordered_map<uint32_t, uint32_t> lenOffset({{8, 0},
                                                  {9, pow(4, 8)},
                                                  {10, 5 * pow(4, 8)},
                                                  {11, 21 * pow(4, 8)},
                                                  {12, 85 * pow(4, 8)}});
...
std::unordered_map<uint32_t, std::string>
    ntMap({{0, "A"}, {1, "C"}, {2, "T"}, {3, "G"}});

std::unordered_map<std::string, std::string>
    revNtMap({{"C", "G"}, {"A", "T"}, {"G", "C"}, {"T", "A"}});

std::vector<std::string> nts{"A", "T", "C", "G"};

template <>
std::string* getReadSequence(apt::CITESeq& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  subseq.clear();
  subseq = seq2.substr(protocol.featureStart, protocol.featureLength);
  return &subseq;
}
template <>
std::string* getReadSequence(apt::DropSeq& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::Chromium& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::ChromiumV3& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::CELSeq& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::CELSeq2& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::SplitSeqV1& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq2; // fastq2 contains barcode and umi
  return &seq;
}
template <>
std::string* getReadSequence(apt::SplitSeqV2& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq2; // fastq2 contains barcode and umi
  return &seq;
}
template <>
std::string* getReadSequence(apt::QuartzSeq2& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::SciSeq3& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::Custom& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::CustomGeometry& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
...
template <>
std::string* getReadSequence(apt::Gemcode& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq;
  return &seq2;
}
template <>
std::string* getReadSequence(apt::InDropV2& protocol, std::string& seq,
                             std::string& seq2, std::string& subseq) {
  (void)seq2;
  return &seq;
}
...
template <>
bool extractUMI<apt::DropSeq>(std::string& read, std::string& read2,
                              apt::DropSeq& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
}
template <>
bool extractUMI<apt::CITESeq>(std::string& read, std::string& read2,
                              apt::CITESeq& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::Chromium>(std::string& read, std::string& read2,
                               apt::Chromium& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::ChromiumV3>(std::string& read, std::string& read2,
                                 apt::ChromiumV3& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::SplitSeqV1>(std::string& read, std::string& read2,
                                 apt::SplitSeqV1& pt, std::string& umi) {
  (void)read;
  return (read2.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read2, 0, pt.umiLength), true)
             : false;
}
template <>
bool extractUMI<apt::SplitSeqV2>(std::string& read, std::string& read2,
                                 apt::SplitSeqV2& pt, std::string& umi) {
  (void)read;
  return (read2.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read2, 0, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::Gemcode>(std::string& read, std::string& read2,
                              apt::Gemcode& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::Custom>(std::string& read, std::string& read2,
                             apt::Custom& pt, std::string& umi) {
  (void)read2;
...
template <>
bool extractUMI<apt::CustomGeometry>(std::string& read1, std::string& read2,
...
template <>
bool extractUMI<apt::QuartzSeq2>(std::string& read, std::string& read2,
                                 apt::QuartzSeq2& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read, pt.barcodeLength, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::CELSeq2>(std::string& read, std::string& read2,
                              apt::CELSeq2& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.umiLength)
             ? (umi.assign(read, 0, pt.umiLength), true)
             : false;
}
template <>
bool extractUMI<apt::SciSeq3>(std::string& read, std::string& read2,
                              apt::SciSeq3& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.barcodeLength + pt.umiLength &&
          pt.anchorPos != std::string::npos)
             ? // for the rare case if barcode has one N and thus gets recovered
             (umi.assign(read, pt.anchorPos + pt.anchorSeqLen, pt.umiLength),
              true)
             : false;
}
template <>
bool extractUMI<apt::CELSeq>(std::string& read, std::string& read2,
                             apt::CELSeq& pt, std::string& umi) {
  (void)read2;
  return (read.length() >= pt.umiLength)
             ? (umi.assign(read, 0, pt.umiLength), true)
             : false;
...
template <>
bool extractUMI<apt::InDropV2>(std::string& read, std::string& read2,
                               apt::InDropV2& pt, std::string& umi) {
  (void)read;
  return (read2.length() >= pt.w1Length + pt.barcodeLength + pt.umiLength)
             ? (umi.assign(read2, pt.bc2EndPos, pt.umiLength), true)
             : false;
  return true;
}

template <>
bool extractBarcode<apt::DropSeq>(std::string& read, std::string& read2,
                                  apt::DropSeq& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
}
template <>
bool extractBarcode<apt::CITESeq>(std::string& read, std::string& read2,
                                  apt::CITESeq& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::ChromiumV3>(std::string& read, std::string& read2,
                                     apt::ChromiumV3& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::Chromium>(std::string& read, std::string& read2,
                                   apt::Chromium& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::Gemcode>(std::string& read, std::string& read2,
                                  apt::Gemcode& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::SciSeq3>(std::string& read, std::string& read2,
                                  apt::SciSeq3& pt, std::string& bc) {
  (void)read2;
  pt.anchorPos = read.find(pt.anchorSeq);
  if (pt.anchorPos != std::string::npos &&
      (pt.anchorPos == pt.maxHairpinIndexLen ||
       pt.anchorPos ==
           pt.maxHairpinIndexLen - 1) // only 2 possible values of pt.anchorPos
      && read.length() >= pt.barcodeLength + pt.umiLength + pt.anchorSeqLen -
                              2) { // Subtract 2 to counter artificial increase
                                   // in barcode length
    std::string bcAssign =
        read.substr(0, pt.anchorPos) +
        read.substr(pt.anchorPos + pt.anchorSeqLen + pt.umiLength, pt.rtIdxLen);
    if (pt.anchorPos <
        pt.maxHairpinIndexLen) { // hairpin index can be 9 or 10 bp
      bcAssign += "AC";
    } else {
      bcAssign += "A";
    }
...
template <>
bool extractBarcode<apt::SplitSeqV1>(std::string& read, std::string& read2,
                                     apt::SplitSeqV1& pt, std::string& bc) {
  (void)read;

  return (read2.length() >= pt.bc3Pos + pt.bcLen)
             ? (bc.assign(read2.substr(pt.bc1Pos, pt.bcLen) +
                              read2.substr(pt.bc2Pos, pt.bcLen) +
                              read2.substr(pt.bc3Pos, pt.bcLen),
                          0, pt.barcodeLength),
                true)
             : false;
}
template <>
bool extractBarcode<apt::SplitSeqV2>(std::string& read, std::string& read2,
                                     apt::SplitSeqV2& pt, std::string& bc) {
  (void)read;
...
template <>
bool extractBarcode<apt::Custom>(std::string& read, std::string& read2,
                                 apt::Custom& pt, std::string& bc) {
  (void)read2;
  if (pt.end == BarcodeEnd::FIVE) {
    return (read.length() >= pt.barcodeLength)
               ? (bc.assign(read, 0, pt.barcodeLength), true)
    ...
    return (read.length() >= (pt.umiLength + pt.barcodeLength))
               ? (bc.assign(read, pt.umiLength, pt.barcodeLength), true)
               : false;
  } else {
    return false;
  }
...
template <>
bool extractBarcode<apt::CustomGeometry>(std::string& read1, std::string& read2,
                                         apt::CustomGeometry& pt,
                                         std::string& bc) {
  return pt.bc_geo.extract_tag(read1, read2, bc);
}
template <>
bool extractBarcode<apt::QuartzSeq2>(std::string& read, std::string& read2,
                                     apt::QuartzSeq2& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= pt.barcodeLength)
             ? (bc.assign(read, 0, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::CELSeq2>(std::string& read, std::string& read2,
                                  apt::CELSeq2& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= (pt.umiLength + pt.barcodeLength))
             ? (bc.assign(read, pt.umiLength, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::CELSeq>(std::string& read, std::string& read2,
                                 apt::CELSeq& pt, std::string& bc) {
  (void)read2;
  return (read.length() >= (pt.umiLength + pt.barcodeLength))
             ? (bc.assign(read, pt.umiLength, pt.barcodeLength), true)
             : false;
...
template <>
bool extractBarcode<apt::InDropV2>(std::string& read, std::string& read2,
  ...
  if (read2.length() >= (pt.w1Length + pt.barcodeLength + pt.umiLength)) {
    ...
    if (pt.w1Pos == std::string::npos) {
      bool found = false;
      for (int i = 8; i <= 11; i++) {
        if (hammingDistance(pt.w1, read2.substr(i, pt.w1Length)) <=
            pt.maxHammingDist) {
          pt.w1Pos = i;
          found = true;
          break;
...
void getIndelNeighbors(const std::string& barcodeSeq,
 ...
 */
void findNeighbors(size_t seqSize, const std::string& barcodeSeq,
                   std::unordered_set<std::string>& neighbors) {
  size_t barcodeLength{barcodeSeq.size()};
  ...
  getIndelNeighbors(barcodeSeq, neighbors);
}

unsigned int hammingDistance(const std::string s1, const std::string s2) {
  if (s1.size() != s2.size()) {
    throw std::invalid_argument(
        "Strings have different lengths, can't compute hamming distance");
  }

  // compute dot product for all postisions, start with 0 and add if the values
  // are not equal
...
void getTxpToGeneMap(spp::sparse_hash_map<uint32_t, uint32_t>& txpToGeneMap,
                     ...
                     std::shared_ptr<spdlog::logger>& jointLog, bool noTgMap) {
...
bool parse_geometry_desc(std::string& geo_string, bool can_be_unbounded,
                         peg::parser& parser, std::vector<Desc>& d,
                         std::shared_ptr<spdlog::logger> log,
                         alevin::protocols::TagGeometry& tg) {
  ...
  if (parser.parse(geo_string.c_str())) {
    ...
    */
    ...
    for (auto& desc : d) {
      ...
      auto& tg_largest_index =
          (rn == 1) ? tg.largest_index1 : tg.largest_index2;
      ...
      for (auto& start_stop : desc.locs) {
        ...
        if (start <= 0) {
          log->error("tag string subscript must be strictly positive (tag "
                     "geometry is 1-indexed).");
          return false;
        }
        size_t stop = start_stop.second;
        // make sure we don't contain `end` if we can't
        if (!can_be_unbounded and stop == std::string::npos) {
          log->error("only the geometry of the read can be unbounded (can "
                     "contain 'end'), "
        ...
        if (stop < start) {
          log->error(
              "geometry contained a range {}-{}; cannot have stop < start.",
              start, stop);
          return false;
        }
        ...
        if (tg_substr_locs.size() >= alevin::protocols::num_tag_pieces) {
          log->error(
              "Currently, alevin does not support the tag (barcode / umi) "
              "being "
...
bool processAlevinOpts(AlevinOpts<ProtocolT>& aopt, SalmonOpts& sopt,
                       bool noTgMap,
  ...
  if (!bfs::exists(aopt.outputDirectory)) {
    bool dirSuccess =
        boost::filesystem::create_directories(aopt.outputDirectory);
    if (!dirSuccess) {
  ...
  aopt.jointLog =
      spdlog::create("alevinLog", std::begin(sinks), std::end(sinks));
  ...
  if (not noTgMap) {
    ...
    if (vm.count("tgMap")) {
      ...
      if (!bfs::exists(aopt.geneMapFile)) {
        aopt.jointLog->critical(
            "Transcript to Gene Map File {} does not exist. Exiting Now.",
            aopt.geneMapFile.string());
        return false;
      }
    } else if (!aopt.just_align) { // eliding a tgMap is only ok if we are
                                   // running in alignment (alevin-fry) mode
      aopt.jointLog->critical(
          "Transcript to Gene Map File not provided. Exiting Now.");
      return false;
    }
  }
  ...
  if (aopt.just_align) {
    aopt.jointLog->info("The --rad flag was passed to alevin. The "
                        "reads will be selectively aligned and the output "
                        "written to a RAD file."
                        "Arguments passed that correspond to other processing "
                        "steps will be ignored");
    if (aopt.sketch_mode) {
      aopt.jointLog->info(
          "The --sketch flag was passed; the alignment will be run "
          "in sketch mode.");
  ...
  if (aopt.numGibbsSamples > 0 and aopt.numBootstraps > 0) {
    aopt.jointLog->error(
        "Either of --numCellGibbsSamples or --numCellBootstraps "
        "can be used");
    return false;
  }
  ...
  if (aopt.keepCBFraction > 0.0) {
    if (vm.count("whitelist")) {
      aopt.jointLog->error(
          "keepCBFraction and whitelist cannot be used together");
      aopt.jointLog->flush();
      exit(1);
    }
  ...
  if (not vm.count("threads")) {
    ...
    aopt.jointLog->warn(
        "threads flag not specified, Using {}(25%) of total cores",
        aopt.numThreads);
  } else {
  ...
  // need both
  bool have_any_custom_geo =
      have_custom_read_geo or have_custom_umi_geo or have_custom_bc_geo;
  bool have_all_custom_geo =
      have_custom_read_geo and have_custom_umi_geo and have_custom_bc_geo;
  if (have_any_custom_geo and !have_all_custom_geo) {
    aopt.jointLog->error(
        "If you are using either of the umi-geometry or \n"
  ...
  if (!noCustom and have_any_custom_geo) {
    aopt.jointLog->warn(
        "Note: the use of --end, --barcodeLength and --umiLength \n"
  ...
  if (allCustom) {
    ...
    if (barcodeLength < 1 or barcodeLength > maxBC) {
      aopt.jointLog->error(
          "Barcode length ({}) was not in the required length range [1, {}].\n"
          "Exiting now.",
          barcodeLength, maxBC);
      return false;
    }
    if (umiLength < 1 or umiLength > maxUMI) {
      aopt.jointLog->error(
          "UMI length ({}) was not in the required length range [1, {}].\n"
          "Exiting now.",
          umiLength, maxUMI);
      return false;
    }
    ...
    if (umiLength != alevin::types::AlevinUMIKmer::k()) {
      ...
      aopt.jointLog->info(
          "A custom protocol (END, BC length, UMI length) = ({}, {}, {}) "
    ...
    if (!(bool)parser) {
      aopt.jointLog->error(
          "Failed to instantiate the tag geometry parser.\n"
    ...
    parser["ReadNumber"] = [&](const peg::SemanticValues& sv) {
      d.push_back({0, {}});
      d.back().read_num = std::stoi(sv.token());
    };
    ...
    parser["NumberRange"] = [&](const peg::SemanticValues& sv) {
      switch (sv.choice()) {
      case 0: {
        d.back().locs.push_back(std::make_pair(peg::any_cast<size_t>(sv[0]),
                                               peg::any_cast<size_t>(sv[1])));
      } break;
      default: {
        d.back().locs.push_back(
            std::make_pair(peg::any_cast<size_t>(sv[0]), std::string::npos));
      } break;
      }
    };
    ...
    if (parse_geometry_desc(bc_geo_string, false, parser, d, aopt.jointLog,
                            bc_geo)) {
      ...
      if ((!aopt.just_align) and bc_geo.uses_r2()) {
        aopt.jointLog->error("Currently, barcodes spanning read 1 and read 2 "
                             ...
                             "Custom barcode geometry without this mode must "
                             "reside entirely on read1. "
                             "If you require custom barcode geometry spanning "
                             "both reads, consider "
      ...
      aopt.jointLog->error("Failed to parse `--bc-geometry` argument {}, "
    ...
    if (parse_geometry_desc(umi_geo_string, false, parser, d, aopt.jointLog,
                            umi_geo)) {
      // if we are *not* in RAD mode, then the UMI cannot span beyond
      // read 1
      if ((!aopt.just_align) and bc_geo.uses_r2()) {
        aopt.jointLog->error(
            "Currently, umis spanning read 1 and read 2 "
            "are supported in alignment/sketch mode only "
            "(i.e. with the --rad flag or the --sketch flag). "
            "Custom umi geometry without this mode must reside entirely on "
            "read1. "
      ...
      aopt.jointLog->error("Failed to parse `--umi-geometry` argument {}, "
                           "please make sure it is correct.",
                           umi_geo_string);
    }
    // std::cerr << "UMI GEO\n---------\n";
    ...
    if (parse_geometry_desc(read_geo_string, true, parser, d, aopt.jointLog,
                            read_geo)) {
      aopt.protocol.set_read_geo(read_geo);
    } else {
      aopt.jointLog->error("Failed to parse `--read-geometry` argument {}, "
                           "please make sure it is correct.",
                           read_geo_string);
    }
    ...
    alevin::types::AlevinCellBarcodeKmer::k(
        static_cast<uint16_t>(bc_geo.length()));
  ...
  if (aopt.iupac.size() > 0) {
    ...
    if (aopt.iupac.size() != aopt.protocol.barcodeLength) {
      aopt.jointLog->error("\nERROR: iupac length: {} and barcode"
                           ...
                           "line flags.\n Exiting Now.",
                           aopt.iupac.size(), aopt.protocol.barcodeLength);
      return false;
    }
  ...
  bool optionsOK = salmon::utils::processQuantOptions(
      sopt, vm, vm["numBiasSamples"].as<int32_t>());
...
bool sequenceCheck(const std::string& sequence,
                   ...
                   // std::mutex& iomutex,
                   Sequence seqType) {
  return (sequence.length() > 0) and
         (sequence.find_first_not_of("ACGTacgt") == std::string::npos);
}
...
void readWhitelist(bfs::path& filePath, TrueBcsT& trueBarcodes) {
...
void combinationUtil(std::vector<uint32_t>& arr, int n, int r, int index,
                     std::vector<uint32_t> data, int i,
                     std::vector<std::vector<uint32_t>>& comb) {
  ...
  if (geneids.size() == 1) {
    ...
    if (gid > numGenes) {
      std::cerr << "Gene id out of range"
                << "Please check txp2gene has the write entries" << std::flush;
      exit(1);
    }
    geneId = gid;
    return true;
...
template bool processAlevinOpts(AlevinOpts<apt::DropSeq>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::CITESeq>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::InDropV2>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::ChromiumV3>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::Chromium>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::Gemcode>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::Custom>& aopt, SalmonOpts& sopt,
                                bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::CustomGeometry>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::CELSeq>& aopt, SalmonOpts& sopt,
                                bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::CELSeq2>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::SciSeq3>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::SplitSeqV1>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::SplitSeqV2>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
template bool processAlevinOpts(AlevinOpts<apt::QuartzSeq2>& aopt,
                                SalmonOpts& sopt, bool noTgMap,
                                boost::program_options::variables_map& vm);
} // namespace utils
} // namespace alevin
